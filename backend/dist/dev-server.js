...
const organizations_1 = require("./functions/organizations");
const onboarding_1 = require("./functions/onboarding");
// Import local adapter to initialize mock services
require("./utils/localAdapter");
...
const sendAPIGatewayResponse = (res, result) => {
    // Set headers
    if (result.headers) {
...
const handleLambdaFunction = (lambdaHandler) => {
...
// Auth routes
app.all('/v1/auth/*', handleLambdaFunction(auth_1.handler));
// Organizations routes  
app.all('/v1/organizations*', handleLambdaFunction(organizations_1.handler));
// Onboarding routes
app.get('/onboarding/status', handleLambdaFunction(onboarding_1.getOnboardingStatus));
app.post('/onboarding/update', handleLambdaFunction(onboarding_1.updateOnboardingStep));
app.post('/onboarding/reset', handleLambdaFunction(onboarding_1.resetOnboarding));
