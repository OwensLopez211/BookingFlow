...
export declare const getItem: (tableName: string, key: Record<string, any>) => Promise<Record<string, any>>;
export declare const putItem: (tableName: string, item: Record<string, any>) => Promise<Record<string, any>>;
export declare const updateItem: (tableName: string, key: Record<string, any>, updates: Record<string, any>) => Promise<Record<string, any>>;
